...
<html lang="en">
  ...
  <title>jquery-match-height/jquery.matchHeight.js at master · liabru/jquery-match-height</title>
  <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta content="https://avatars3.githubusercontent.com/u/654420?v=3&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="liabru/jquery-match-height" property="og:title" /><meta content="https://github.com/liabru/jquery-match-height" property="og:url" /><meta content="jquery-match-height - a responsive equal heights plugin for jQuery" property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTc2MDc5NDE5OjE3Nzk2ZWJlYzY4YTBlOTg1MjBmNGIxMGE2OTRlNTFkZWY3NmQxMzFlMDAwMGM2ZWFkZjY3ODQxN2RhYTA4ODY=--ac7174e5205eb0e298acfc314742ade7101b0c2d">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E1E4:1E56:48FA984:6CC6C4E:595CA9BE" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="E1E4:1E56:48FA984:6CC6C4E:595CA9BE" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="5869159" name="octolytics-actor-id" /><meta content="aquamoose" name="octolytics-actor-login" /><meta content="a8b86cc84ab9caae97a7eb64117103566bd552d67d66c7e71faad093dd2ba609" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="aquamoose">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">


  <meta name="html-safe-nonce" content="f091171ccb4f4ec75c6300ce5500f0d5c81d18bd">
  ...
  <meta name="description" content="jquery-match-height - a responsive equal heights plugin for jQuery">
  <meta name="go-import" content="github.com/liabru/jquery-match-height git https://github.com/liabru/jquery-match-height.git">

  <meta content="654420" name="octolytics-dimension-user_id" /><meta content="liabru" name="octolytics-dimension-user_login" /><meta content="17341429" name="octolytics-dimension-repository_id" /><meta content="liabru/jquery-match-height" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="17341429" name="octolytics-dimension-repository_network_root_id" /><meta content="liabru/jquery-match-height" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<div class="header" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/search" class="js-site-search-form" data-scoped-search-url="/liabru/jquery-match-height/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/liabru/jquery-match-height/blob/master/jquery.matchHeight.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator " data-channel="notification-changed:5869159" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="liabru/jquery-match-height">This repository</span>
  </div>
    <a class="dropdown-item" href="/liabru/jquery-match-height/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/aquamoose"
       aria-label="View profile and more"
       aria-expanded="false"
       aria-haspopup="true"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@aquamoose" class="avatar" src="https://avatars3.githubusercontent.com/u/5869159?v=3&amp;s=40" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">aquamoose</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/aquamoose" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/aquamoose?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="DqUCuS3CUhg4ig7uBHbL5E29fwzJ+NksjSBX9yV935MN6BeErSuPpwMQpev0VFIi9vQcHGurorN/BgEX4FD/Hg==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="hNl5evbtzvQ+27uuT68FPM/idSqKM6Mpzuk+O+lcgceHlGxHdgQTSwVBEKu/jZz6dKsWOihg2LY8z2jbLHGhSg==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="LqOw3pwyls2P0c9A5GTm3Jy2IyMJk4ALVqQ9JiVhx9wKYEpyJjDb76IO7vshQf6BecXtXWET//kjFFSTGUgo/Q==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="17341429" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/liabru/jquery-match-height/subscription"
            ...
            <a class="social-count js-social-count"
              href="/liabru/jquery-match-height/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="KwqZzdmFQNHBWphAm+Y6slIxTbf5dckg4nIU93TyKBiAnJ+n/f1EgofgXh346BxkBAaKDVCdyJBe8adp9hKqcw==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar liabru/jquery-match-height"
        ...
        <a class="social-count js-social-count" href="/liabru/jquery-match-height/stargazers"
           aria-label="2574 users starred this repository">
          2,574
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rEsKlFojMZFah1RCkurtCtVLcNt1YBhR2oat/yF6GVOTn19jrycQZPMJUX2HpSJa2M4+shtA1P19ET8xSxf+xQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star liabru/jquery-match-height"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="+blam4jMIJMtDwygCXQFv96jwu4B/ba5veTgf+JVNa6PtpAOQLZm7Ml06OzXgEvSifEzFLguZ4gb+6g7PLZtRg==" /></div>
            <button
                type="submit"
                class="btn btn-sm btn-with-count"
                data-ga-click="Repository, show fork modal, action:blob#show; text:Fork"
                title="Fork your own copy of liabru/jquery-match-height to your account"
                aria-label="Fork your own copy of liabru/jquery-match-height to your account">
...
--><strong itemprop="name"><a href="/liabru/jquery-match-height" data-pjax="#js-repo-pjax-container">jquery-match-height</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/liabru/jquery-match-height" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /liabru/jquery-match-height" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/liabru/jquery-match-height/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /liabru/jquery-match-height/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/liabru/jquery-match-height/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /liabru/jquery-match-height/pulls" itemprop="url">
    ...
    <a href="/liabru/jquery-match-height/projects" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /liabru/jquery-match-height/projects">
      <svg aria-hidden="true" class="octicon octicon-project" height="16" version="1.1" viewBox="0 0 15 16" width="15"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a href="/liabru/jquery-match-height/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /liabru/jquery-match-height/wiki">
    ...
    <div class="reponav-dropdown js-menu-container">
      ...
      <div class="dropdown-menu-content js-menu-content">
        <div class="dropdown-menu dropdown-menu-sw">
          <a class="dropdown-item" href="/liabru/jquery-match-height/pulse" data-skip-pjax>
            <svg aria-hidden="true" class="octicon octicon-pulse" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"/></svg>
            Pulse
          </a>
          <a class="dropdown-item" href="/liabru/jquery-match-height/graphs" data-skip-pjax>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/liabru/jquery-match-height/blob/2446ac654f694bc05a1297cbab0b2d875e278bbd/jquery.matchHeight.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:d92f8040fd94e6a01fe4c822401a68bf -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/liabru/jquery-match-height/blob/master/jquery.matchHeight.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.7.2/jquery.matchHeight.js"
              data-name="0.7.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.7.1/jquery.matchHeight.js"
              data-name="0.7.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.7.0/jquery.matchHeight.js"
              data-name="0.7.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.6.0/jquery.matchHeight.js"
              data-name="0.6.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.5.2/jquery.matchHeight.js"
              data-name="0.5.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.5.1/jquery.matchHeight.js"
              data-name="0.5.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/liabru/jquery-match-height/tree/0.5.0/jquery.matchHeight.js"
              data-name="0.5.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/liabru/jquery-match-height"><span>jquery-match-height</span></a></span></span><span class="separator">/</span><strong class="final-path">jquery.matchHeight.js</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/liabru/jquery-match-height/commit/e468ae9089e9476c2349be4b00e5cb49987e659b" data-pjax>
          e468ae9
        </a>
        <relative-time datetime="2017-02-19T18:04:25Z">Feb 19, 2017</relative-time>
      </span>
      <div>
        <img alt="@liabru" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/654420?v=3&amp;s=40" width="20" />
        <a href="/liabru" class="user-mention" rel="author">liabru</a>
          <a href="/liabru/jquery-match-height/commit/e468ae9089e9476c2349be4b00e5cb49987e659b" class="message" data-pjax="true" title="change $.bind to $.on where supported, closes #120 and #145">change $.bind to $.on where supported, closes</a> <a href="https://github.com/liabru/jquery-match-height/pull/120" class="issue-link js-issue-link" data-url="https://github.com/liabru/jquery-match-height/issues/120" data-id="163178832" data-error-text="Failed to load issue title" data-permission-text="Issue title is private">#120</a> <a href="/liabru/jquery-match-height/commit/e468ae9089e9476c2349be4b00e5cb49987e659b" class="message" data-pjax="true" title="change $.bind to $.on where supported, closes #120 and #145">and</a> <a href="https://github.com/liabru/jquery-match-height/pull/145" class="issue-link js-issue-link" data-url="https://github.com/liabru/jquery-match-height/issues/145" data-id="207842736" data-error-text="Failed to load issue title" data-permission-text="Issue title is private">#145</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>7</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="liabru" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=liabru"><img alt="@liabru" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/654420?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="stefanozoffoli" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=stefanozoffoli"><img alt="@stefanozoffoli" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1004488?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="nyordanov" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=nyordanov"><img alt="@nyordanov" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/192220?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="kfriend" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=kfriend"><img alt="@kfriend" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/634835?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="jorrit" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=jorrit"><img alt="@jorrit" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/521449?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="jonscottclark" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=jonscottclark"><img alt="@jonscottclark" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/214676?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="dcorb" href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js?author=dcorb"><img alt="@dcorb" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/881333?v=3&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@liabru" height="24" src="https://avatars1.githubusercontent.com/u/654420?v=3&amp;s=48" width="24" />
            <a href="/liabru">liabru</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@stefanozoffoli" height="24" src="https://avatars0.githubusercontent.com/u/1004488?v=3&amp;s=48" width="24" />
            <a href="/stefanozoffoli">stefanozoffoli</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@nyordanov" height="24" src="https://avatars3.githubusercontent.com/u/192220?v=3&amp;s=48" width="24" />
            <a href="/nyordanov">nyordanov</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@kfriend" height="24" src="https://avatars2.githubusercontent.com/u/634835?v=3&amp;s=48" width="24" />
            <a href="/kfriend">kfriend</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@jorrit" height="24" src="https://avatars2.githubusercontent.com/u/521449?v=3&amp;s=48" width="24" />
            <a href="/jorrit">jorrit</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@jonscottclark" height="24" src="https://avatars3.githubusercontent.com/u/214676?v=3&amp;s=48" width="24" />
            <a href="/jonscottclark">jonscottclark</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@dcorb" height="24" src="https://avatars0.githubusercontent.com/u/881333?v=3&amp;s=48" width="24" />
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/liabru/jquery-match-height/raw/master/jquery.matchHeight.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/liabru/jquery-match-height/blame/master/jquery.matchHeight.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/liabru/jquery-match-height/commits/master/jquery.matchHeight.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/edit/master/jquery.matchHeight.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="897VoF7jumNGe1q+NjKoe12UBitJfgXm6glF7gEtW4K8hEEWt6RUGZ6UOhMxUHr0gmQdNMVmrVDcIei4XCSoJg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/liabru/jquery-match-height/delete/master/jquery.matchHeight.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="WM+jYioDS4mZio7klH+u+fRBdq23Pgzq9n5p4WNUm/yJRXdxR1DdKnBeuIPtz69mi58oy10B59k8oKhPWHOYpg==" /></div>
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.12700s from github-fe-fdcdb84.cp1-iad.github.net">GitHub</span>, Inc.</li>
